...
<div class="container-fluid py-md-5 py-0 bg-black text-white footer-bg">
    <div class="container">
        ...
        <div class="row mb-md-4 mb-2">
            <div class="col-md-3 col-12">
                <div class="pb-2 mb-2">
                    ...
                    <p class="mb-0">
                        <span class="fw-bold"> Streamo Digital </span> <br>
            ...
            <div class="col-md-3 col-12">
                <div class="social-link">
                    <ul class="ps-0 d-flex justify-content-between">
                        ...
                        <li class="list-unstyled"> <a href="https://www.youtube.com/@StreamoDigital" class="text-white">
                        ...
                        <li class="list-unstyled"> <a href="https://www.facebook.com/StreamoDigitalbd"
                                class="text-white">
                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor"
                        ...
                        <li class="list-unstyled"> <a href="https://www.instagram.com/streamodigitalbd/"
                                class="text-white">
                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor"
                        ...
                        <li class="list-unstyled"> <a href="https://www.linkedin.com/company/streamodigital/"
                                class="text-white">
                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor"
        ...
        <div
            class="border-top border-secondary pt-2 pb-5 row align-items-center justify-content-md-between justify-content-center">
            <div class="w-auto px-0">
                ...
                </svg> All Right Reserved
            </div>

            <div class="w-auto px-0">
                <div class="footer-menu">
                    <ul class="list-unstyled pe-md-0 ps-0 overflow-hidden mb-0 d-flex footer-menu-privacy ">
                        <li> <a class="text-white pe-md-2 pe-0" href="privacy.php"> Privacy </a> </li>
                        <li> <a class="text-white ps-2" href="terms-and-condition.php"> Terms and Condition </a>
                        </li>
                    </ul>
                </div>
            </div>
